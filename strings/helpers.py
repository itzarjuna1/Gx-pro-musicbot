...
ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ:
ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴʏ ᴍᴜsɪᴄ ᴅɪʀᴇᴄᴛʟʏ ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ ɪɴ ғɪʟᴇ ғᴏʀᴍᴀᴛ.

ᴜꜱᴀɢᴇ:
• /music (music name)

ꜰᴇᴀᴛᴜʀᴇꜱ:
• ғᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ ᴜsɪɴɢ ᴄᴜsᴛᴏᴍ ᴀᴘɪ  
• sᴇɴᴅs ᴀᴜᴅɪᴏ ᴀs ᴅᴏᴡɴʟᴏᴀᴅᴀʙʟᴇ ғɪʟᴇ  
• sᴜᴘᴘᴏʀᴛs ᴍᴏsᴛ sᴏɴɢs  

ɴᴏᴛᴇ:
ᴍᴀᴋᴇ sᴜʀᴇ ᴛᴏ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴠᴀʟɪᴅ sᴏɴɢ ɴᴀᴍᴇ.
"""
